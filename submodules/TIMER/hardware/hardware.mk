...
VHDR+=$(TIMER_HW_INC_DIR)/TIMER_sw_reg_gen.v
...
$(TIMER_HW_INC_DIR)/TIMER_sw_reg_gen.v: $(TIMER_HW_INC_DIR)/TIMER_sw_reg.v
	$(LIB_DIR)/software/mkregs.py $< HW
	mv TIMER_sw_reg_gen.v $(TIMER_HW_INC_DIR)
	mv TIMER_sw_reg_w.vh $(TIMER_HW_INC_DIR)
